...
import com.dmsxa.maplibui.util.NGIDUtils;
...
import com.dmsxa.mobile.fragment.LayersFragment;
import com.dmsxa.mobile.fragment.MapFragment;
...
import static com.dmsxa.maplib.util.Constants.SUPPORT;
...
import static com.dmsxa.maplibui.service.TrackerService.hasUnfinishedTracks;
        ...
        implements GpsEventListener, IChooseLayerResult
{
    ...
    public void showEditToolbar() {
        ...
        MenuItem item = mToolbar.getMenu().findItem(R.id.menu_edit_redo);
        boolean visible = mMapFragment.getMode() != MapFragment.MODE_EDIT_BY_WALK;
        item.setVisible(visible);
        item = mToolbar.getMenu().findItem(R.id.menu_edit_undo);
        item.setVisible(visible);
